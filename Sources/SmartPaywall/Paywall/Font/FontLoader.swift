...
public class FontRegister {
    public static func loadFonts() {
        _ = UIFont.registerFont(bundle: .module, fontName: "SF-Pro-Display-Regular", fontExtension: "otf")
        _ = UIFont.registerFont(bundle: .module, fontName: "SF-Pro-Display-Medium", fontExtension: "otf")
